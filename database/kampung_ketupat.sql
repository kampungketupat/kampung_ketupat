...
('admin', '$2y$12$DCiUgLmhdwawm0UIgB//qejw41J08Q/TcKoGEtac1rmxA7V9u5p9i', 'Administrator Kampung Ketupat');
...
INSERT INTO galeri (judul, deskripsi, foto, kategori, is_publish) VALUES
('Monumen Ketupat Raksasa', 'Ikon utama Kampung Ketupat Warna Warni yang menjadi spot foto favorit pengunjung.', 'https://images.unsplash.com/photo-1533906966484-a9c978a3f090?w=800&q=80', 'wisata', 1),
('Rumah Warna-Warni', 'Rumah-rumah warga yang dicat warna cerah menjadi daya tarik visual utama kampung ini.', 'https://images.unsplash.com/photo-1566552881560-0be862a7c445?w=800&q=80', 'wisata', 1),
('Pemandangan Sungai Mahakam', 'Suasana tepi Sungai Mahakam yang indah dengan latar Jembatan Mahkota II.', 'https://images.unsplash.com/photo-1565060169187-9b5f6382b7d7?w=800&q=80', 'wisata', 1),
('Proses Pembuatan Ketupat', 'Warga menganyam kulit ketupat dari daun nipah secara turun-temurun.', 'https://images.unsplash.com/photo-1502602898657-3e91760cbb34?w=800&q=80', 'budaya', 1),
('Kuliner Khas Lokal', 'Soto Banjar yang disajikan bersama ketupat produksi lokal.', 'https://images.unsplash.com/photo-1517248135467-4c7edcad34c4?w=800&q=80', 'kuliner', 1),
('Area Santai Tepi Sungai', 'Fasilitas area santai dan taman bermain di tepi Sungai Mahakam.', 'https://images.unsplash.com/photo-1545239351-1141bd82e8a6?w=800&q=80', 'fasilitas', 1);
...
INSERT INTO kritik_saran (nama_pengunjung, email, jenis, pesan, status, sudah_dibaca) VALUES
('Ahmad Fauzi', 'ahmad@email.com', 'apresiasi', 'Kampung Ketupat sangat indah dan terawat! Pengalaman belajar membuat ketupat sangat berkesan untuk keluarga kami.', 'pending', 1),
('Dewi Rahayu', 'dewi@email.com', 'saran', 'Semoga bisa ditambah papan penunjuk arah yang lebih jelas dari jalan utama agar wisatawan mudah menemukan lokasi.', 'pending', 0),
('Budi Santoso', '', 'kritik', 'Tempat parkir kurang luas saat akhir pekan, semoga bisa diperluas lagi.', 'pending', 0);
